...
const createListingSchema = z.object({
  ...
  budgetType: z.enum(["fixed", "range", "hourly"]),
...
export async function createListing(formData: FormData) {
  ...
  const listing = await prisma.listing.create({
    data: {
      ...
      hourlyRate: data.budgetType === "hourly" ? data.hourlyRate : null,
      budgetKind: data.budgetType,
...
export async function updateListing(listingId: string, formData: FormData) {
  ...
  await prisma.listing.update({
    ...
    data: {
      ...
      hourlyRate: data.data.budgetType === "hourly" ? data.data.hourlyRate : null,
      budgetKind: data.data.budgetType,
